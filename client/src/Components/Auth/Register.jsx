...
function Register() {
   ...
   const handleRegister = data => {
      const obj = {
         ...
         avatarUrl: 'https://i.pinimg.com/564x/57/00/c0/5700c04197ee9a4372a35ef16eb78f4e.jpg',
   ...
   return (
      <>
         ...
         <div className="auth-wrapper">
            <form className="auth-container" onSubmit={handleSubmit(handleRegister)}>
               <div className="form-group">
                  <label className="group-name">{t('header.auth.username.name')}</label>
                  <div className="input-check-box">
                     ...
                     />
                     {errors.username && <i style={{ color: 'red' }} className="fas fa-check"></i>}
                     {!errors.username && (
               ...
               <div className="form-group">
                  ...
                  <div className="input-check-box">
                     ...
                     />
                     {errors.email && <i style={{ color: 'red' }} className="fas fa-check"></i>}
                     {!errors.email && <i style={{ color: 'green' }} className="fas fa-check"></i>}
                  </div>
               </div>
               <div className="form-group">
                  <label className="group-name" htmlFor="email">
                  ...
                  <div className="input-check-box">
                     ...
                     />
                     {errors.password && <i style={{ color: 'red' }} className="fas fa-check"></i>}
                     {!errors.password && (
                        <i style={{ color: 'green' }} className="fas fa-check"></i>
                     )}
                  </div>
               ...
               {user.role === 'admin' && (
                  <div className="form-group">
                     ...
                     <div className="input-check-box">
                        ...
                        {errors.gender && <i style={{ color: 'red' }} className="fas fa-check"></i>}
                        {!errors.gender && (
                           <i style={{ color: 'green' }} className="fas fa-check"></i>
                        )}
                     </div>
               ...
               <div className="form-group">
                  ...
                  <div className="input-check-box">
                     ...
                     />
                     {errors.address && <i style={{ color: 'red' }} className="fas fa-check"></i>}
                     {!errors.address && (
                        <i style={{ color: 'green' }} className="fas fa-check"></i>
                     )}
                  </div>
               ...
               <div className="form-group">
                  ...
                  <div className="input-check-box">
                     ...
                     />
                     {errors.phone && <i style={{ color: 'red' }} className="fas fa-check"></i>}
                     {!errors.phone && <i style={{ color: 'green' }} className="fas fa-check"></i>}
                  </div>
               </div>
               <div className="form-group">
                  ...
                  <div className="input-check-box">
                     ...
                     />
                     {errors.birthday && <i style={{ color: 'red' }} className="fas fa-check"></i>}
                     {!errors.birthday && (
                        <i style={{ color: 'green' }} className="fas fa-check"></i>
                     )}
                  </div>
                     ...
                     <div className="input-radio-box">
                        ...
                        <div className="input-radio-item">
                           <input
                              ...
                              value={0}
                           />
                           <label htmlFor="female"> {t('header.auth.gender.female')}</label>
                        </div>
                     </div>
                     {errors.gender && <i style={{ color: 'red' }} className="fas fa-check"></i>}
                     {!errors.gender && <i style={{ color: 'green' }} className="fas fa-check"></i>}
                  </div>
               </div>
               <div className="form-group">
                  <label className="group-name">{t('header.auth.departments.name')}</label>
                  <br />
                  <div className="input-check-box">
                     <i className="fas fa-key"></i>
                     <select
