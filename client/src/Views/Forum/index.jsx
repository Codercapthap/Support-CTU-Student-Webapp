...
function Forum() {
   ...
   const [departmentName, setDepartmentName] = useState(t('forum.part.department.empty'));
   ...
   const showAllPosts = async id => {
      ...
      const fillterData = data.filter(d => d.is_deleted !== 1 && d.is_accepted === 1);
      // const fillterData = data.filter(d => d.is_deleted !== 1);
         ...
         <div className="accordion-container">
            ...
            <div className="accordion-box">
               <div className="accordion-item tab_1">
                  <a href="#tab_1" className="title text-overflow">
                     <i className="fa-solid fa-square-caret-down"></i> {t('forum.part.topics.name')}{' '}
                     [{t('forum.part.topics.total')}: {topics.length}]
                  </a>
                  <div className="body">
                     <div className="body-item">
                        {topics.length === 0 && (
                           <div className="topics-empty">{t('forum.part.topics.empty')}</div>
                        )}
                     ...
                     {showControlTopic.create && (
                        <div className="create-topic-box">
                           ...
                           <div className="create-topic-item">
                              <label htmlFor="description">topic description:</label> <br />
                              <input
                                 type="text"
                                 name="description"
               ...
               <div className="accordion-item tab_2">
                  <a href="#tab_2" className="title text-overflow">
                     <i className="fa-solid fa-square-caret-down"></i> {t('forum.part.posts.name')}{' '}
                     [{t('forum.part.posts.total')}: {posts.length || 0}]
                  </a>
                  <div className="body">
                     {posts.length === 0 && (
                        <div className="topics-empty">{t('forum.part.topics.empty')}</div>
                     ...
                     <div className="post-container">
                        {posts?.map(post => (
                           <div className="post-item-list" key={post.id} dataKey={post.id}>
                              <PostBrief
                                 post={post}
                     ...
                     {JSON.stringify(post) !== JSON.stringify({}) && (
                        <div className="post-container">
                           ...
                           <div className="show-comment" onClick={toggleCommentBox}>
                              {comments.length === 0 && <i className="fa-solid fa-caret-down"></i>}
                              {comments.length !== 0 && <i className="fa-solid fa-caret-up"></i>}
