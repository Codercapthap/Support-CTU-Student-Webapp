...
class Document {
  ...
  static deleteOneById(id) {
    return new Promise(function (resolve, reject) {
      ...
      var sql =
        "UPDATE document set is_deleted = 1, deleted_at = ? WHERE id = ?";
  ...
  static deleteDocuments(deletedAt, key, value) {
    return new Promise(function (resolve, reject) {
      var sql =
        "UPDATE document set is_deleted = 1, deleted_at = ? WHERE " +
        key +
        " = ?";
  ...
  static restoreDocuments(key, value) {
    return new Promise(function (resolve, reject) {
      var sql =
        "UPDATE document set is_deleted = 0, deleted_at = null WHERE " +
        key +
        " = ?";
      connection.query(sql, value, function (err, result, fields) {
        if (err) reject(err);
